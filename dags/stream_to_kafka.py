...
async def generate_and_stream_data(producer, endpoint: str, topic: str):
	while True:
...
async def streaming_kafka_main():
	tasks = []
...
if __name__ == "__main__":
	producer = create_kafka_producer(
		['127.0.0.1:9092', '127.0.0.1:9093', 'localhost:9094'])
	asyncio.run(streaming_kafka_main())

#kafka-server-start.bat D:\Apps\kafka_2.13-3.5.0\config\server-9093.properties
#zookeeper-server-start D:\Apps\kafka_2.13-3.5.0\config\zookeeper.properties